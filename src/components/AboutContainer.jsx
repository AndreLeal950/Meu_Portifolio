...
const AboutContainer = () => {
  return (
    <section className="about-container">
      <h2>Sobre</h2>
      <p>Me chamo André Leal, tenho 48 anos, casado ha vinte e oito anos,
        temos duas filhas.Confessso, que a programação foi uma das  tarefas
        mais difíceis  que  me  propus aprender. Me desafiei, persisti e consegui
